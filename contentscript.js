...
function handleExistingWebms()
{
    ...
    {
        //Get post text
        var webmPostContents = webms[i].innerText;
        ...
        if(webmFile.name.substr(-4) === "webm")
        {
            ...
            $.ajax(
            {
                ...
                success: function(data)
                {
                    ...
                    var thumbnailURL = $(resultDocument.find(".form-control")[2].innerText).find("img").attr("src");
                    ...
                    $("#postform textarea")[0].value = "[spoiler][webmdata]"+window.btoa(directPlayURL)+"[/webmdata] Para veres o vídeo instala a extensão (Google Chrome) https://github.com/ptchanextension/PTChan-Chrome-Extension/raw/master/PTChan-Chrome-Extension.crx[/spoiler]\n"+$("#postform textarea")[0].value;
